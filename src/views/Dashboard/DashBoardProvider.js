...
const useStyles = makeStyles(styles);
  ...
  export default function DashBoard(props) {
    ...
    const calculateTotal = () => { 
      let orderStateToCompare = 4     
      let orderStateInput = document.getElementById('estado')
      if(orderStateInput.textContent !== 'Ninguno' && orderStateInput.textContent !== "​"){
        orderStateToCompare =   getOrderIdState(orderStateInput.textContent)
      }      
                    ...
                    <Grid item xs={12} sm={12} md={6} style={{textAlign:"center"}}>
                      <FormControl variant="outlined" style ={{width:"180px"}}>
                        ...
                        >
                          ...
                          <MenuItem value={5}>Pagado</MenuItem>
                          <MenuItem value={6}>Transferido</MenuItem>                                                    
                        </Select>
                      </FormControl>
                    </Grid>
                    <Grid item xs={12} sm={12} md={6} style={{textAlign:"center"}} >
